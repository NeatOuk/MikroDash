class SystemCollector {
  ...
  async tick() {
    ...
    try {
      ...
      r =
        ...
        resResult.value[0]
          ...
          : {};
      h =
        healthResult.status === "fulfilled" && Array.isArray(healthResult.value)
          ? healthResult.value
          : [];
      u =
      ...
      // M-5: One-time debug log gated behind ROS_DEBUG to avoid production noise.
    ...
    const hddPct =
      totalHdd > 0 ? Math.round(((totalHdd - freeHdd) / totalHdd) * 100) : 0;
